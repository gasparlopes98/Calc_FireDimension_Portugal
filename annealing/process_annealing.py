...
path_distance_matrix_location = "annealing/file_info/distance_matrix.txt"
path_resources_by_severity = "annealing/severidade_info.json"
path_resources_by_zone = "file_info/resources_zone.json"
...
def process_info(fire_severity_by_zone):
    ...
    return allocation_matrix,calculate_distance_traveled(allocation_matrix, need)
