...
'''
    ...
    distance = pr.calculate_distance_traveled(allocation_matrix, needed_resources) / get_max_distance(needed_resources) * 100
...
if __name__ == "__main__":
    ...
    print(f"Final Cost: {int(pr.calculate_distance_traveled(anneal_solution,dict_fire))}")
